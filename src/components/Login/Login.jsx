  ...
  return (
    <main className="min-h-screen bg-[#f5f6f7] px-4 py-3 sm:px-6">
      ...
      <div className="mx-auto w-full max-w-2xl rounded-3xl bg-white shadow-sm">
        {" "}
        <div className="flex w-full flex-col px-6 py-12 sm:px-10 md:px-12">
          {" "}
          {/* ================= HEADER ================= */}{" "}
          <div className="text-center">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm leading-5 text-[#78909c]">
              {" "}
              Enter your credential details to resume your personal
              roadmap.{" "}
            </p>{" "}
          </div>{" "}
          {/* ================= FORM ================= */}{" "}
          <form onSubmit={handleSubmit} className="mt-5">
            ...
            <div className="mb-8">
              ...
              <input
                ...
                className=" h-11 w-full rounded-xl border-2 border-[#082f44] px-4 text-sm text-[#18394b] outline-none transition placeholder:text-[#9aa7ae] focus:ring-2 focus:ring-[#082f44]/10 "
              />{" "}
            </div>{" "}
            {/* ================= PASSWORD ================= */}{" "}
            <div className="mb-8">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className=" h-11 w-full rounded-xl border-2 border-[#082f44] px-4 pr-12 text-sm text-[#18394b] outline-none transition placeholder:text-[#9aa7ae] focus:ring-2 focus:ring-[#082f44]/10 "
                />{" "}
                {/* Show / Hide Password */}{" "}
                <button
                  type="button"
                ...
                >
                  ...
                  {showPassword ? (
                    ...
                    >
                      ...
                      <path d="M6.61 6.61C4.62 8 2 12 2 12s3 8 10 8a9.8 9.8 0 0 1 4.39-1.03" />{" "}
                    </svg>
                  ) : (
                    <svg
                      width="19"
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              <Link
                to="/forgot-password"
                className=" text-xs font-semibold text-[#082f44] transition hover:underline "
              >
                {" "}
                Forgot Password?{" "}
              </Link>{" "}
            ...
            <div className="mt-6">
              ...
              <button
                ...
                className=" h-11 w-full rounded-full bg-[#082f44] text-base font-bold text-white transition duration-300 hover:bg-[#0d405b] active:scale-[0.99] "
              >
                {" "}
                Sign In{" "}
              </button>{" "}
